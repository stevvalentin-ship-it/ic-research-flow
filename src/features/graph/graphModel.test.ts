...
const analyses = [
  { paperId: 'a', references: [{ title: 'B', authors: [], matchedPaperId: 'b', relation: 'extends' }] },
  { paperId: 'outside-core', references: [{ title: 'B', authors: [], matchedPaperId: 'b', relation: 'background' }] },
] as unknown as PaperAnalysis[]
const scores = [
